...
| `skim/` | PN14_SID1259 (Zd), PN3_SID235 (Zx), PN17_SID1630 (Zx) | `counts/<s>.chr1.tsv` | `expected_calls_chr1.csv` (25 segs, 11 non-REF) |
...
- Skim counts: `data/rtiger_50K/counts/<group>/` (BC2S2, ~0.4×).
